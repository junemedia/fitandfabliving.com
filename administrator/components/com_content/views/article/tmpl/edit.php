				...
				<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CONTENT_ARTICLE_DETAILS', true)); ?>
					<fieldset class="adminform">
						<div class="control-group form-inline">
							...
							<?php echo $this->form->getInput('sponsored'); ?> <?php echo $this->form->getLabel('sponsored'); ?>
						</div>
						<?php echo $this->form->getInput('articletext'); ?>
						<?php echo $this->form->getLabel('nextarticle'); ?> <?php echo $this->form->getInput('nextarticle'); ?>
					</fieldset>
					<?php
