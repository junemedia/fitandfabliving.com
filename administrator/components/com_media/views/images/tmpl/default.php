		...
		<div class="row">
			<div class="span6 control-group">
				...
				<div class="controls">
					...
					<input type="hidden" id="f_url_hidden" value="" />
				</div>
				<div>
				<a href="cropimage/crop.php?validate=" id="crop_btn"><button type="button" class="btn btn-primary" onclick="<?php if ($this->state->get('field.id')):?>window.parent.jInsertFieldValue(document.id('f_url_hidden').value,'<?php echo $this->state->get('field.id');?>');<?php else:?>ImageManager.onok();<?php endif;?>">Crop Current Image</button></a>
			</div>
			</div>
