...
abstract class JHtmlFormbehavior
{
	...
	public static function chosen($selector = '.advancedSelect', $debug = null)
	{
		...
		JHtml::_('script', 'components/com_obrss/assets/jui/js/chosen.jquery.min.js', false, true, false, false, $debug);
		JHtml::_('stylesheet', 'components/com_obrss/assets/jui/css/chosen.css', false, true);
