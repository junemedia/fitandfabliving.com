...
abstract class JHtmlSortablelist
{
	...
	public static function sortable($tableId, $formId, $sortDir = 'asc', $saveOrderingUrl, $proceedSaveOrderButton = true, $nestedList = false)
	{
		...
		JHtml::_('script', 'components/com_obrss/assets/jui/js/sortablelist.js', false, false);
		JHtml::_('stylesheet', 'components/com_obrss/assets/jui/css/sortablelist.css', false, true, false);
