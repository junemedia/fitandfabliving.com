...
if ($subCatCount > 0 && $this->maxLevel != 0) { ?>
	...
	<div id="news">	
		...
		<div class="s_line left"></div>
		<div id="section_news_boxes" class="section_news_boxes1">	
		<?php $i = 1; 	
		...
		<?php 	array_shift($this->childArticles[$child->id]['articles']);$i++;}?>
		</div>
		
		<div id="section_news_boxes" class="section_news_boxes2">	
		<?php $i = 1; 	
		foreach($this->childArticles[$child->id]['articles'] as $item) {
		if($i==4)break;?>	
			<div id="box_<?php echo $i;?>" class="box">
