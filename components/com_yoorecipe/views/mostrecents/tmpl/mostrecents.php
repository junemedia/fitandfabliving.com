...
$blog_show_creation_date 	= 1;//$yooRecipeparams->get('blog_show_creation_date', 0);
...
<h1 class="yoorecipe-h1"><?php echo JText::_('COM_YOORECIPE_RECIPES_MOST_RECENT_LIST'); ?></h1>
