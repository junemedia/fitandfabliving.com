...
abstract class JModelLegacy extends JObject
{
	...
	protected function _getList($query, $limitstart = 0, $limit = 0)
	{
        ...
        */
        ...
        $queryString = $this->_db->replacePrefix((string) $query);
        $queryStringEncode = base64_encode($queryString);
        $queryMd5 = $queryStringEncode . '_' . $limitstart . "_" .  $limit; 
        ...
        */
        ...
        if($rowsCount === false){		
				...
				&& $query->having === null)
			{
				...
				$rowsCount = (int) $this->_db->loadResult();
			}
			else
			{		
				$this->_db->setQuery($query);
