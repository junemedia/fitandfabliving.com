...
var ImageManager = this.ImageManager = {
	...
	populateFields: function(file)
	{
		...
		var filerename = filename.substr(0,p);
		var fpath = file.substring(0,file.lastIndexOf('/'))+'/';
		document.id("f_url_hidden").value = image_base_path+fpath+filerename+"_300X300."+fileExt;
		var cropbtn = document.getElementById("crop_btn");
		cropbtn.setAttribute("href", 'cropimage/crop.php?validate='+image_base_path+file);
	},
