...
class PlgSearchContent extends JPlugin
{
	...
	public function onContentSearch($text, $phrase = '', $ordering = '', $areas = null)
	{
		...
		if ($sContent && $limit > 0)
		{
			...
			$query->select('a.id,a.title AS title, a.metadesc, a.metakey, a.created AS created,a.images')
		...
		if ($sArchived && $limit > 0)
		{
			...
			$query->select(
				'a.id,a.title AS title, a.metadesc, a.metakey, a.created AS created, a.images,'
