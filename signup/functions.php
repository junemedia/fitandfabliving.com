...
function LookupImpressionWise($email_addr) {
	...
	if($npd=='041')
	{
		...
		$result = mysql_query("INSERT INTO report_details (linkid,subcampid,actionType,email,dateAdded,serverResponse,ipaddress) VALUES ('','','impressionwise_041', '" . $email_addr . "', '".$today."','".$npd."','".$ipaddress."')");
		return true;
	}
