	...
	if ($message == '') {	
		switch($guid) {
			...
			case '5D419A5D0F124FBEAA4A2DEBAB01DA6F':
				...
				break;
			default:
                                $subcampid = '4372';    // FF Default Giveaway 0615
		}
		...
		$sPostingUrl = "http://fitfab.popularliving.com/fitfab_api_giveaway2.php?email=$EMAIL&sublists=410,448,411&subcampid=$subcampid&ipaddr=$ipaddr&keycode=kfdj49358gkj359gjk55";
...
if (false&&date('m') == 03 || date('m') == 04) {
	...
	$giveaway_extra_right_img = '<br><br><img src="http://pics.fitandfabliving.com/giveaway/FF_giveaway_LifeTrak_logo.png" width="50%">';
}

if (false&&date('m') == 05 || date('m') == 06) {
	$giveaway_title = "";
	...
	$giveaway_top_img = "http://pics.fitandfabliving.com/giveaway/FF_Juices-1.JPG";
	$giveaway_right_img = "http://pics.fitandfabliving.com/giveaway/FF_Juices-1.JPG";
	$giveaway_extra_right_img = '<br><br><img src="http://pics.fitandfabliving.com/giveaway/FF_Juices-1.JPG" width="50%">';
}
...
<tr>
	...
	<td align="left" valign="top"><img src="<?php echo $giveaway_right_img; ?>"><?php echo $giveaway_extra_right_img; ?></td>
</tr>
</table>
</body>
</html>
