				...
				<div class="main_content">
					<div class="article">
						...
						<div class="article_content">
							<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/article_img.jpg" />
...
You will need: <font style="color:#85A7D4;font-weight:bold;">Free weights</font>
							</div>
						</div>
						<div id="more_articles">
							...
							<div class="article_box">
								<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/article_more1.jpg" class="article_box_img"/>
								<div class="article_box_content">
									<h2 class="article_box_title">5 Ways To Stay In Shape Much Easier</h2>
									<div class="article_box_brief">Lorem ipsum dolor sit ametum estiamuc et aen brevs mordun estiam et convictus breventum quod venistu erenat mor etiam es... <a href="#" class="read_more">read more...</a></div>								
								</div>
							</div>
							<div class="article_box box_top_space">
								<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/article_more2.jpg"class="article_box_img"/>
								<div class="article_box_content">
									<h2 class="article_box_title">Tips For Strong Abs And Arms</h2>
									<div class="article_box_brief">Lorem ipsum dolor sit ametum estiamuc et aen brevs mordun estiam et convictus breventum quod venistu erenat mor etiam es... <a href="#" class="read_more">read more...</a></div>						
								</div>
							</div>
							<div class="article_box box_top_space">
								<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/article_more3.jpg"class="article_box_img"/>
								<div class="article_box_content">
									<h2 class="article_box_title">How To Get In Shape With Leona Lewis</h2>
									<div class="article_box_brief">Lorem ipsum dolor sit ametum estiamuc et aen brevs mordun estiam et convictus breventum quod venistu erenat mor etiam es... <a href="#" class="read_more">read more...</a></div>							
								</div>
							</div>
						</div>
