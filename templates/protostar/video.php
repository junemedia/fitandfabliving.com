		...
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			...
			<div class="row-fluid">
				<div class="main_content">
					<div class="video">
						<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/video_reserve.jpg"/>
					</div>
					<div class="article">
						...
						<div class="author_info"><span>by </span> <span class="name">Mariah Benedict</span> <div class="article_social"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/article_social.jpg"/></div></div>
						...
						<div id="featured_video">
							<h2 class="content_h2">FEATURED VIDEOS</h2>
							<div class="s_line"></div>
							<div id="video_box">						
								<div id="box_1" class="box">
									<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/video_featured1.jpg" class="box_img"/>
									<div class="box_content">Lorem ipsum dolor sit ametum brevis... <a href="#" class="read_more">read more...</a></div>
								</div>
								<div id="box_2" class="box">
									<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/video_featured2.jpg" class="box_img"/>
									<div class="box_content">Lorem ipsum dolor sit ametum brevis... <a href="#" class="read_more">read more...</a></div>
								</div>
								<div id="box_3" class="box">
									<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/temp/video_featured3.jpg" class="box_img"/>
									<div class="box_content">Lorem ipsum dolor sit ametum brevis... <a href="#" class="read_more">read more...</a></div>
								</div>
							</div>
						</div>
